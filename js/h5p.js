  ...
  H5P.jQuery('.h5p-content:not(.h5p-initialized)', target).each(function () {
   ...
   // $element.append('<div class="h5p-popup-dialog h5p-embed-dialog h5p-open" aria-labelledby="embed-dialog-header" aria-modal="true" role="dialog" tabindex="-1">                              <div class="h5p-inner">                                <h2 id="embed-dialog-header">Embed</h2>                                <div class="h5p-scroll-content"><div class="h5p-trial-warning"><b>WARNING:</b> H5P.org is only for trying out H5P. The embed option will be limited soon. Do not use H5P.org to host real content. <a href="https://h5p.org/h5p-org-only-for-testing-h5p" target="_blank">Learn more</a></div><textarea class="h5p-embed-code-container" autocorrect="off" autocapitalize="off" spellcheck="false" style="height: 30px;"></textarea>Size: <input aria-label="width" type="text" value="1091" class="h5p-embed-size"> × <input aria-label="width" type="text" value="675" class="h5p-embed-size"> px<br><div role="button" tabindex="0" class="h5p-expander h5p-open" aria-expanded="false">Hide advanced</div><div class="h5p-expander-content" style="display: block;"><p>Include this script on your website if you want dynamic sizing of the embedded content:</p><textarea class="h5p-embed-code-container" autocorrect="off" autocapitalize="off" spellcheck="false" style="height: 30px;">&lt;script src="https://h5p.org/sites/all/modules/h5p/library/js/h5p-resizer.js" charset="UTF-8"&gt;&lt;/script&gt;</textarea></div></div>                                <div class="h5p-close" role="button" tabindex="0" aria-label="Close" title="Close"></div>                              </div>                            </div>');
    ...
    function changeThemeBlue() {
      ...
      r.style.setProperty('--h5p-theme-contrast-cta-light', 'color-mix(in srgb, var(--h5p-theme-main-cta-base), transparent 90%)');
      r.style.setProperty('--h5p-theme-secondary-cta-light', '#101b59');
      r.style.setProperty('--h5p-theme-secondary-cta-dark', '#090f34');
      r.style.setProperty('--h5p-theme-secondary-contrast-cta', '#e7eafa');
      r.style.setProperty('--h5p-theme-alternative-light', '#F8F9FE');
      r.style.setProperty('--h5p-theme-alternative-dark', '#DCDFFA');
      r.style.setProperty('--h5p-theme-alternative-darker', '#ced1ee');
      r.style.setProperty('--h5p-theme-text-primary', '#101729');
      r.style.setProperty('--h5p-theme-text-secondary', '#354054');
      r.style.setProperty('--h5p-theme-text-third', '#737373');
      r.style.setProperty('--h5p-theme-ui-base', '#FFFFFF');
      r.style.setProperty('--h5p-theme-stroke-1', '#DCDFFA');
      r.style.setProperty('--h5p-theme-stroke-2', '#EDEEFB');
      r.style.setProperty('--h5p-theme-stroke-3', '#E5E5E5');
      r.style.setProperty('--h5p-theme-feedback-correct-main', '#256D1D');
      r.style.setProperty('--h5p-theme-feedback-correct-secondary', '#f3fcf0');
      r.style.setProperty('--h5p-theme-feedback-correct-third', '#cff1c2'); 
      r.style.setProperty('--h5p-theme-feedback-incorrect-main', '#a13236');
    ...
    function changeThemePurple() {
      ...
      r.style.setProperty('--h5p-theme-secondary-cta-base', '#000000');
      r.style.setProperty('--h5p-theme-alternative-base', '#f3edff');
      r.style.setProperty('--h5p-theme-background', '#F3EEFA');
      r.style.setProperty('--h5p-theme-focus', '#F1EBFA');
      r.style.setProperty('--h5p-theme-main-cta-light', '#8347DD');
      r.style.setProperty('--h5p-theme-main-cta-dark', '#692EC2');
      r.style.setProperty('--h5p-theme-contrast-cta', '#ffffff');
      r.style.setProperty('--h5p-theme-contrast-cta-white', '#834DD5');
      r.style.setProperty('--h5p-theme-contrast-cta-light', 'color-mix(in srgb, var(--h5p-theme-main-cta-base), transparent 90%)');
      r.style.setProperty('--h5p-theme-secondary-cta-light', '#333333');
      r.style.setProperty('--h5p-theme-secondary-cta-dark', '#311B50');
      r.style.setProperty('--h5p-theme-secondary-contrast-cta', '#F3F1F5');
      r.style.setProperty('--h5p-theme-alternative-light', '#f8f5ff');
      r.style.setProperty('--h5p-theme-alternative-dark', '#e8d9ff');
      r.style.setProperty('--h5p-theme-alternative-darker', '#ddc7ff');
      r.style.setProperty('--h5p-theme-text-primary', '#101729');
      r.style.setProperty('--h5p-theme-text-secondary', '#1b1346');
      r.style.setProperty('--h5p-theme-text-third', '#737373');
      r.style.setProperty('--h5p-theme-ui-base', '#FFFFFF');
      r.style.setProperty('--h5p-theme-stroke-1', '#ead8f6');
      r.style.setProperty('--h5p-theme-stroke-2', '#EDEEFB');
      r.style.setProperty('--h5p-theme-stroke-3', '#E5E5E5');
      r.style.setProperty('--h5p-theme-feedback-correct-main', '#256D1D');
      r.style.setProperty('--h5p-theme-feedback-correct-secondary', '#f3fcf0');
    ...
    function changeThemeGreen() {
      ...
      r.style.setProperty('--h5p-theme-secondary-cta-base', '#000000');
      r.style.setProperty('--h5p-theme-alternative-base', '#FAF4E6');
      r.style.setProperty('--h5p-theme-background', '#FCF9F2');
      r.style.setProperty('--h5p-theme-focus', '#F1EBFA');
      r.style.setProperty('--h5p-theme-main-cta-light', '#00B2A0');
      r.style.setProperty('--h5p-theme-main-cta-dark', '#004D45');
      r.style.setProperty('--h5p-theme-contrast-cta', '#ffffff');
      r.style.setProperty('--h5p-theme-contrast-cta-white', '#17948b');
      r.style.setProperty('--h5p-theme-contrast-cta-light', 'color-mix(in srgb, var(--h5p-theme-main-cta-base), transparent 90%)');
      r.style.setProperty('--h5p-theme-secondary-cta-light', '#333333');
      r.style.setProperty('--h5p-theme-secondary-cta-dark', '#311B50');
      r.style.setProperty('--h5p-theme-secondary-contrast-cta', '#F3F1F5');
      r.style.setProperty('--h5p-theme-alternative-light', '#FCF9F2');
      r.style.setProperty('--h5p-theme-alternative-dark', '#F2E3BF');
      r.style.setProperty('--h5p-theme-alternative-darker', '#EEDAAA');
      r.style.setProperty('--h5p-theme-text-primary', '#101729');
      r.style.setProperty('--h5p-theme-text-secondary', '#05252e');
      r.style.setProperty('--h5p-theme-text-third', '#737373');
      r.style.setProperty('--h5p-theme-ui-base', '#FFFFFF');
      r.style.setProperty('--h5p-theme-stroke-1', '#cceae8');
      r.style.setProperty('--h5p-theme-stroke-2', '#EDEEFB');
      r.style.setProperty('--h5p-theme-stroke-3', '#E5E5E5');
      r.style.setProperty('--h5p-theme-feedback-correct-main', '#256D1D');
      r.style.setProperty('--h5p-theme-feedback-correct-secondary', '#f3fcf0');
    ...
    function changeThemeOrange() {
      ...
      r.style.setProperty('--h5p-theme-secondary-cta-base', '#172326');
      r.style.setProperty('--h5p-theme-alternative-base', '#FFF2ED');
      r.style.setProperty('--h5p-theme-background', '#FFF2ED');
      r.style.setProperty('--h5p-theme-focus', '#F1EBFA');
      r.style.setProperty('--h5p-theme-main-cta-light', '#F5511F');
      r.style.setProperty('--h5p-theme-main-cta-dark', '#AF320B');
      r.style.setProperty('--h5p-theme-contrast-cta', '#ffffff');
      r.style.setProperty('--h5p-theme-contrast-cta-white', '#D63A0A');
      r.style.setProperty('--h5p-theme-contrast-cta-light', 'color-mix(in srgb, var(--h5p-theme-main-cta-base), transparent 90%)');
      r.style.setProperty('--h5p-theme-secondary-cta-light', '#263A3F');
      r.style.setProperty('--h5p-theme-secondary-cta-dark', '#121A1D');
      r.style.setProperty('--h5p-theme-secondary-contrast-cta', '#F3F1F5');
      r.style.setProperty('--h5p-theme-alternative-light', '#FDF8F7');
      r.style.setProperty('--h5p-theme-alternative-dark', '#F2DBD4');
      r.style.setProperty('--h5p-theme-alternative-darker', '#FFCFBA');
      r.style.setProperty('--h5p-theme-text-primary', '#101729');
      r.style.setProperty('--h5p-theme-text-secondary', '#2c0f03');
      r.style.setProperty('--h5p-theme-text-third', '#737373');
      r.style.setProperty('--h5p-theme-ui-base', '#FFFFFF');
      r.style.setProperty('--h5p-theme-stroke-1', '#f2dbd4');
      r.style.setProperty('--h5p-theme-stroke-2', '#EDEEFB');
      r.style.setProperty('--h5p-theme-stroke-3', '#E5E5E5');
      r.style.setProperty('--h5p-theme-feedback-correct-main', '#256D1D');
      r.style.setProperty('--h5p-theme-feedback-correct-secondary', '#f3fcf0');
    ...
    function changeThemeDark() {
      ...
      r.style.setProperty('--h5p-theme-secondary-contrast-cta', '#000000');
      r.style.setProperty('--h5p-theme-alternative-light', '#1C1C1C');
      r.style.setProperty('--h5p-theme-alternative-dark', '#2e2c36');
      r.style.setProperty('--h5p-theme-alternative-darker', '#000000');
      r.style.setProperty('--h5p-theme-text-primary', '#FFFFFF');
      r.style.setProperty('--h5p-theme-text-secondary', '#BEC1C5');
      r.style.setProperty('--h5p-theme-text-third', '#919191');
      r.style.setProperty('--h5p-theme-ui-base', '#1C1C1C');
      r.style.setProperty('--h5p-theme-stroke-1', '#33313B');
      r.style.setProperty('--h5p-theme-stroke-2', '#3b3b3b');
      r.style.setProperty('--h5p-theme-stroke-3', '#33313B');
      r.style.setProperty('--h5p-theme-feedback-correct-main', '#dbf5d0');
      r.style.setProperty('--h5p-theme-feedback-correct-secondary', '#293227');
      r.style.setProperty('--h5p-theme-feedback-correct-third', '#53624d'); 
    ...
    function changeThemeSmall(){
      c.classList.remove("h5p-large"); 
      c.classList.remove("h5p-medium"); 
      c.classList.add("h5p-small"); 
    }
    
    function changeThemeMedium(){
      c.classList.remove("h5p-small"); 
      c.classList.remove("h5p-large"); 
      c.classList.add("h5p-medium"); 
    }
    
     function changeThemeLarge(){
      c.classList.remove("h5p-small"); 
      c.classList.remove("h5p-medium"); 
    ...
    $button4.appendTo($Colorcontainer);
    $button5.appendTo($Colorcontainer);
     
    $button6.appendTo($Sizecontainer);
